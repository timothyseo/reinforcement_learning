...
class Env(tk.Tk):
    ...
    def load_images(self):
        rectangle = ImageTk.PhotoImage(Image.open(os.path.join(self.img_path, "rectangle.png")).resize((30, 30)))
        triangle = ImageTk.PhotoImage(Image.open(os.path.join(self.img_path, "triangle.png")).resize((30, 30)))
        circle = ImageTk.PhotoImage(Image.open(os.path.join(self.img_path, "circle.png")).resize((30, 30)))
